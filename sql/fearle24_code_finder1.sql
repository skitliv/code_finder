...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-02-2021 a las 18:14:09
...
--
ALTER TABLE `lenguajes`
  MODIFY `Idlenguaje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `usercodes`
  MODIFY `IDuserCodes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=174;
