...
--
-- Host: localhost:3306
-- Generation Time: Jan 23, 2021 at 07:28 PM
...
(8, 'ftp connection remote', ' ftp domain_name\r\nusername\r\npassword   / / will not be visible ', ' ', 0, 0, 0, ' https://kb.globalscape.com/Knowledgebase/10224/Establishing-an-FTP-Connection-from-the-Command-Prompt');
...
--
-- Table structure for table `d3js`
--
...
INSERT INTO `prueba` (`ID`, `String1`, `String2`, `String3`, `Numero1`, `Numero2`, `Numero3`, `string4`) VALUES
(1, 'Nurie', 'Porras', 'Lopez', 10, 15, 22, NULL),
(2, 'Esfania', 'Perez', 'Reggae', 10, 15, 22, NULL),
(3, 'Roberto', 'Velasco', 'Metal', 10, 15, 22, NULL),
(4, 'Nurie', 'Lopez', 'Sorano', 10, 15, 22, NULL),
(5, 'Nurie', 'velasco', 'Lopez', 10, 15, 22, NULL),
(6, 'Nurie', 'death', 'Lopez', 10, 15, 22, NULL),
(7, 'Nurie', 'satan', 'Lopez', 10, 15, 22, NULL),
(8, 'Nurie', 'jesus', 'Lopez', 10, 15, 22, NULL),
(10, 'git commit ', 'Sirve para commit the changes made', '', 0, 0, 0, NULL),
(11, 'sdkfjsdkfj', '', '', 0, 0, 0, NULL),
(12, 'tania', 'hola mundo como estas ', '', 0, 0, 0, NULL),
(13, 'git checkout -- index.html', ' Is used to undo changes // use (--)  to make sure no c', '', 0, 0, 0, NULL),
(14, 'prueba', ' hola mai goa como estas yo esoty bien she is here I wi', '', 0, 0, 0, NULL),
(15, 'hol', 'ses un aprueba ', '', 0, 0, 0, NULL),
(16, 'pruba', 'a ver si funciona ', '', 0, 0, 0, NULL),
(17, 'black metal', 'Mayhem ', '', 0, 0, 0, NULL),
(18, 'paradigma', 'es una prueba \r\n ', '', 0, 0, 0, NULL),
(19, 'git checkout file.html ', ' Restore changes in the directory', '', 0, 0, 0, NULL),
(20, 'diff index.txt', 'to see what changes file file   ', '', 0, 0, 0, NULL),
(21, 'diff', ' ', '', 0, 0, 0, NULL),
(22, 'git diff', ' ', '', 0, 0, 0, NULL),
(23, 'git diff index.html', 'to see what changes file ', '', 0, 0, 0, NULL),
(24, 'nunca mas', 'es el sentimineto que me enbuelbe ', '', 0, 0, 0, NULL);
...
--
-- Dumping data for table `reactjs`
--
...
--
-- Table structure for table `sublime`
--
...
--
-- Dumping data for table `sublime`
--
...
--
-- AUTO_INCREMENT for table `oracle`
--
ALTER TABLE `oracle`
...
--
-- AUTO_INCREMENT for table `sql`
--
ALTER TABLE `sql`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sublime`
--
ALTER TABLE `sublime`
